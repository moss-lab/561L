...
# filter the results based on input parameters
#
# Usage:
#
...
MFE_wig = pyBigWig.open(filename+'.filtered_MFE.bw', 'w')
zscore_wig = pyBigWig.open(filename+'.filtered_zscore.bw', 'w')
pscore_wig = pyBigWig.open(filename+'.filtered_pscore.bw', 'w')
ED_wig = pyBigWig.open(filename+'.filtered_Ed.bw', 'w')
fMFE_wig = pyBigWig.open(filename+'.filtered_fMFE.bw', 'w')
gff3file = open(filename+'.gff3', 'w')
        ...
        for row in lines:
            ...
            if data[4] == "Undef":
                ...
                if zscore > 1:
                    ...
                    MFE_list.append(float(00000))
                    zscore_list.append(float(00000))
                    pscore_list.append(float(00000))
                    ED_list.append(float(00000))
                    fMFE_list.append(float(00000))
